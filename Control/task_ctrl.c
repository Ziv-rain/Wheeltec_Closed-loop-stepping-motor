...
void TaskCtrl_FeedByte(uint8_t b){uint8_t t,l,*d;if(aa55(&rx0,b,&t,&l,&d)){ts.lrx=tms;ts.link=1;if(t==0x40&&l==4)pushq(d[0],d[1],(int16_t)((uint16_t)d[2]|((uint16_t)d[3]<<8)));}}
